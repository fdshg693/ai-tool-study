# GihubCopilotChat拡張機能が提供するコマンド「/savePrompt」の具体的な内容

以下のコマンドからプロンプトが確認できる（Macの場合）：
```cat ~/.vscode/extensions/github.copilot-chat-0.33.1/assets/prompts/savePrompt.prompt.md```
```
---
name: savePrompt
